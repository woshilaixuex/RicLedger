package com.elyric.ricledger.ui.fragment.setting
...
class SettingFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val changeThemeButton: Button = view.findViewById(R.id.changeTheme)
        changeThemeButton.setOnClickListener {
            lifecycleScope.launch {
                ...
                ThemeHelper.setTheme(requireContext(), nextTheme)
            }
        }
        return view
    }
